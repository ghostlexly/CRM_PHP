...
// ---------------- //
	...
	$stmt_paged = $pdo->prepare("SELECT * FROM Factures WHERE statut = '1' ORDER BY numero_facture DESC LIMIT :start_from, :Items_Par_Page");
    ...
    $ClientInfos = GetClientInfos_FromID($ent['id_client']);
		?>
                        <tr>
                          ...
                          <td>
                            <span class="badge badge-default badge-success badge-lg">Réglée</span>
                          </td>
                          <td>
                            <span class="dropdown">
