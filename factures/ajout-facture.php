...
<?php include('libs/ajout-facture_getinfos.php'); ?>

<div class="app-content content">
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Ajouter une facture</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form class="form row" method="POST" action="ajout-facture.php?idclient=<?php if(isset($_GET['idclient'])) { echo $_GET['idclient']; } else { echo "0"; } ?>">
                      <div class="col-md-12">
                        <h4 class="form-section"><i class="la la-eye"></i> Informations du client</h4>
                      </div>

<div class="col-md-12"><?php include('libs/ajout-facture_system.php'); ?></div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="Désignation" name="designation_facture" value="<?php echo C_Input_Frm_Post('designation_facture'); ?>" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="FA-AAMM-0001" name="numero_facturation" value="<?php if(C_Input_Frm_Post('numero_facturation') !== null) { echo C_Input_Frm_Post('numero_facturation'); } else { echo Gen_Facture_Numero(); } ?>" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group col-12 mb-2 file-repeater detail_facture">
                        <div data-repeater-list="repeater-list-prestations">
                          <?php if(isset($_POST['repeater-list-prestations'])) { include('libs/factures_prestations_list.php'); GetListPrestations_POST($_POST['repeater-list-prestations']); } else { ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="Coûts externes" name="couts_externes" value="<?php echo C_Input_Frm_Post('couts_externes'); ?>" required>
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-12 mb-2 file-repeater detail_facture">
                        <div data-repeater-list="repeater-list-intervenants">
                          <?php if(isset($_POST['repeater-list-intervenants'])) { include('libs/factures_marges_list.php'); GetListMarges_POST($_POST['repeater-list-intervenants']); } else { ?>
