    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Factures en attente</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/index.php">Accueil</a>
                </li>
                <li class="breadcrumb-item active">Factures en attente
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card-head">
                <div class="card-header">
                  ...
                  <div class="heading-elements">
                    <a href="ajout-facture.php"><button class="btn btn-primary btn-sm"><i class="ft-plus white"></i> Créer une facture</button></a>
                    <span class="dropdown">
...
<?php include('libs/liste-factures-enattente_table_content.php'); ?>
