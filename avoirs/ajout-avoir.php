...
<?php include('libs/ajout-avoir_getinfos.php'); ?>

<div class="app-content content">
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Ajouter un avoir</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-content collapse show">
                  <div class="card-body">
                    <form class="form row" method="POST" action="ajout-avoir.php?idclient=<?php if(isset($_GET['idclient'])) { echo $_GET['idclient']; } else { echo "0"; } ?>">
                      <div class="col-md-12">
                        <h4 class="form-section"><i class="la la-eye"></i> Informations du client</h4>
                      </div>

<div class="col-md-12"><?php include('libs/ajout-avoir_system.php'); ?></div>
                      ...
                      <?php if(C_Input_Frm_Post('choix_facture')) { ?><script>$(function() { $("[name='choix_facture']").val('<?php echo C_Input_Frm_Post('choix_facture'); ?>'); });</script><?php } ?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="Désignation" name="designation_avoir" value="<?php echo C_Input_Frm_Post('designation_avoir'); ?>" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="FA-AAMM-0001" name="numero_avoir" value="<?php if(C_Input_Frm_Post('numero_avoir') !== null) { echo C_Input_Frm_Post('numero_avoir'); } else { echo Gen_Avoir_Numero(); } ?>" required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group col-12 mb-2 file-repeater detail_facture">
                        <div data-repeater-list="repeater-list-prestations">
                          <?php if(isset($_POST['repeater-list-prestations'])) { include('libs/avoirs_prestations_list.php'); GetListPrestations_POST($_POST['repeater-list-prestations']); } else { ?>
