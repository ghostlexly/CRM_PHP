...
if(isset($_GET['id_facture'])) {
	...
	$_GET['id'] = $Fact_id;
	include("$_SERVER[DOCUMENT_ROOT]/factures/libs/modifier-facture_getinfos.php");

	$_GET['id'] = $FactureInfos['id_client'];
	...
	exit("Un problème est survenu lors de l'assignation des données sur la facture.");
}
