...
if(isset($_GET['id_devis'])) {
	...
	$_GET['id'] = $Fact_id;
	include("$_SERVER[DOCUMENT_ROOT]/devis/libs/modifier-devis_getinfos.php");

	$_GET['id'] = $DevisInfos['id_client'];
	...
	exit("Un problème est survenu lors de l'assignation des données sur le devis.");
}
