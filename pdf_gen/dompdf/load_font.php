...
//Edited by DubSeven
$_SERVER["argv"][1] = "La Belle Aurore"; // Nom du font à appeler dans le CSS
$_SERVER["argv"][2] = "LaBelleAurore.ttf"; // Nom du fichier à placer dans le même répertoire qu'il va copier
$_SERVER["argc"] = 3;
$fontname = "La Belle Aurore"; // Nom du font à appeler dans le CSS
$normal = "LaBelleAurore.ttf"; // Nom du fichier à placer dans le même répertoire qu'il va copier
//Edited by DubSeven
...
if ( $_SERVER["argv"][1] === "system_fonts" ) {
  ...
  call_user_func_array("install_font_family", array_merge( array($dompdf), array_slice($_SERVER["argv"], 0) ));
}